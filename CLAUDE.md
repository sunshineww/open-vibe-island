...
- `main` always equals `upstream/main` + local customizations (e.g. codex hook trace logging, localized docs, codex PermissionRequest hook). Main is *supposed* to be ahead of upstream — do NOT try to remove local commits to "match upstream".
